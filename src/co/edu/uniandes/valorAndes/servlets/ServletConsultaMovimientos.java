...
public class ServletConsultaMovimientos  extends HttpServlet {
	...
	private void responder(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		try {   			
			...
			salida.println("        ");
			salida.println("");
			salida.println("        <form class=\"well\" action=\"consultarMovimientos1.htm\" method=\"POST\">");
			salida.println("");
			salida.println("       <t>Ingrese el rango de tiempo por el cual desea consultar los movimientos de valores:</t>");
			salida.println("");
			salida.println("			<div class=\"span1 pull-Left\">");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"fecha inicial (DD/MM/YY)\" name=\"textoFechaInicial\">");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"fecha final (DD/MM/YY)\" name=\"textoFechaFinal\">");
			salida.println("");
			salida.println("            	<t>Ingrese la informacion de acuerdo a un solo criterio de busqueda:</t>");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Identificador del Valor\" name=\"textoValorID\">");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Tipo del Valor\" name=\"textoValorTipo\">");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Tipo de Rentabilidad del Valor\" name=\"textoRentabilidadTipo\">");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Identificador del Inversionista\" name=\"InversionistaId\">");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Identificador del Oferente\" name=\"OferenteId\">");
			salida.println("");
			salida.println("            	<button type=\"submit\" class=\"btn btn-default\">Buscar</button>");
			salida.println("");
			salida.println("			</div>			");
			...
			salida.println("		</form>");
			salida.println("");
			salida.println("		<form class=\"well\" action=\"consultarMovimientos2.htm\" method=\"POST\">");
			salida.println("");
			salida.println("       <t>Ingrese el rango de tiempo por el cual desea consultar los movimientos de valores:</t>");
			salida.println("");
			salida.println("			<div class=\"span1 pull-Left\">");
			...
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"fecha final (DD/MM/YY)\" name=\"textoFechaFinal\">");
			salida.println("");
			salida.println("            	<t>Ingrese el criterio de búsqueda sobre el que desee que no salga informacion:</t>");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Identificador del Valor\" name=\"textoValorID\">");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Tipo del Valor\" name=\"textoValorTipo\">");
			...
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Tipo de Rentabilidad del Valor\" name=\"textoRentabilidadTipo\">");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Identificador del Intermediario\" name=\"IntermediarioId\">");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Identificador del Inversionista\" name=\"InversionistaId\">");
			salida.println("");
			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"Identificador del Oferente\" name=\"OferenteId\">");
