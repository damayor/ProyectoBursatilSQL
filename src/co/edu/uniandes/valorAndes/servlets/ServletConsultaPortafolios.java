...
public class ServletConsultaPortafolios extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
   	...
   	private void responder(HttpServletRequest request, HttpServletResponse response) throws IOException
   	{
   		...
   		String tipo = request.getParameter("textoValorTipo");
   		String numero=request.getParameter("textoComparar");
   		...
   		try {   			
   			...
   			pw.println("        </div>    ");
   			pw.println("    ");
   			cab.darPortofolios(tipo, numero, pw);
