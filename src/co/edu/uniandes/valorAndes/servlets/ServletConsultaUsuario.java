...
public class ServletConsultaUsuario extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
   	...
   	private void responder(HttpServletRequest request, HttpServletResponse response) throws IOException
   	{
   		...
   		String tipoUsuario = request.getParameter("textoTipoUser");
   		String tipoOpe = request.getParameter("textoTipoOp");
   		String monto = request.getParameter("textoMonto");
   		Double costo=Double.parseDouble(monto);
   		String fechaI = request.getParameter("textoFechaI");
   		...
   		try {   			
   			...
   			cab.darOperacionesUsuario(pw, tipoUsuario, tipoOpe, fechaI, fechaF, costo);
   			pw.println("    <footer>      ");
