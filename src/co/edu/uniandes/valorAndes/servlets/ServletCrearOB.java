...
public class ServletCrearOB extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
   	...
   	private void responder(HttpServletRequest request, HttpServletResponse response) throws IOException
   	{
   		...
   		String ventaOCompra=request.getParameter("textoOperacion");
   		String montoS=request.getParameter("textoMonto");
   		Double monto=Double.parseDouble(montoS);
   		String logIntermediario=request.getParameter("textoLogin");
   		String idValorNegociado=request.getParameter("textoValor");
   		String fechaExp=request.getParameter("textoFecha");
   		...
   		try {   			
   			...
   			pw.println("        </div>    ");
   			pw.println("    ");
   			cab.ordenarOperacionBursatilMonto(pw,ventaOCompra, monto, logIntermediario, idValorNegociado, fechaExp);
   			pw.println("    <footer>      ");
