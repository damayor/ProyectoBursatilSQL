...
public class ServletEliminarOB extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
   	...
   	private void responder(HttpServletRequest request, HttpServletResponse response) throws IOException
   	{
   		...
   		try {   			
   			...
   			pw.println("");
   			pw.println("	<title>Valor andes</title>");
   			pw.println("");
   			...
   			pw.println("        </div>    ");
   			pw.println("    ");
   			cab.cancelarOperacionBursatil(pw,ventaOCompra, monto, logIntermediario, idValorNegociado, fechaExp);
   			pw.println("");
