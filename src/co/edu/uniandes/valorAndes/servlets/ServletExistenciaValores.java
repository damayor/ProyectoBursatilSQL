...
public class ServletExistenciaValores extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
   	...
   	{
   		System.out.println("Respondiendo ServletConsultaUsuario");
   		ValorAndes cab = ValorAndes.darInstancia();
   		PrintWriter pw = response.getWriter();
   		String valor = request.getParameter("textoValor");
   		String fechaF = request.getParameter("textoFechaF");
   		...
   		try {   			
   			...
   			pw.println("        </div>    ");
   			pw.println("    ");
   			//System.out.println("Todo bn hasta aca los parametros son:"+tipoUsuario+" "+tipoOpe+" "+fechaI+" "+fechaF+" "+costo);
   			cab.darExistenciaValores(pw,valor, fechaF, fechaF, false, fechaF, fechaF, fechaF, fechaF );
   			pw.println("    <footer>      ");
   			pw.println("        <p><a class=\"TextCopy\" href=\"https://www.facebook.com/camilo.carrillo.587\">&copy; Camilo Andres Carrillo Ni&#241o</a></p> ");
   			pw.println("    </footer>");
   			pw.println("");
