...
public class ServletRetirarIntermediario extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
   	...
   	private void responder(HttpServletRequest request, HttpServletResponse response) throws IOException
   	{
   		...
   		{   			
   			...
   			salida.println("        ");
   			salida.println("");
   			salida.println("        <form class=\"well\" action=\"eliminarIntermediario.htm\" method=\"POST\">");
   			salida.println("");
   			salida.println("       <t>Escriba el Login del intermediario a sacar del sistema</t>");
   			salida.println("");
   			salida.println("			<div class=\"span1 pull-Left\">");
   			salida.println("");
   			salida.println("            ");
   			salida.println("");
   			salida.println("            	<input type=\"text\" class=\"form-control\" placeholder=\"\" name=\"textoLogin\">");
   			salida.println("");
   			salida.println("            	<button type=\"submit\" class=\"btn btn-default\">Retirar</button>");
   			salida.println("");
   			salida.println("			</div>			");
   			salida.println("");
   			salida.println("		</form> ");
