...
//ESTE SERVLET RESPONDE EL FORMULARIO PRESENTE EN SERVLETALMACEN
public class ServletVisualizarIntermediarios  extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
   	...
   	private void responder(HttpServletRequest request, HttpServletResponse response) throws IOException
   	{
   		...
   		String txtPOR= request.getParameter("txtPORCENTAJE");
   		...
   		try {   			
   			...
   			salida.println("");
   			salida.println("                  <a class=\"navbar-brand\">CabAndes</a>                    ");
   			salida.println("");
   			salida.println("                </div>");
   			salida.println("");
   			salida.println("                ");
   			...
   			salida.println("");
   			salida.println("        <p><a class=\"TextCopy\" href=\"https://www.facebook.com/juan.s.castro.7\">&copy; Juan Sebastian Castro Duarte</a></p> ");
   			salida.println("");
   			salida.println("    </footer>");
   			salida.println("");
   			salida.println("");
